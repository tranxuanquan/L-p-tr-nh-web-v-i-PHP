...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['add'])) {
        ...
        $sql = "INSERT INTO products (name, price, img, description, stock) VALUES ('$name', '$price', '$img', '$desc', '$stock')";
        $conn->query($sql);
    }
    if (isset($_POST['edit'])) {
        $id = $_POST['id'];
  ...
  <div class="admin-content">
    ...
    <div class="form-section">
      ...
      <form method="post">
        ...
        <input type="number" name="stock" placeholder="Số lượng hàng" min="0" required>
